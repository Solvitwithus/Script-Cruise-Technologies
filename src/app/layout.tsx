...
export const metadata: Metadata =  {
  ...
  authors: [{ name: "Script Cruise Technologies", url: "https://script-cruise-technologies.vercel.app" }],
  metadataBase: new URL("https://script-cruise-technologies.vercel.app"), // Replace with your real domain
  openGraph: {
    title: "Script Cruise Technologies",
    description: "Automation and ERP solutions for the modern business.",
    url: "https://script-cruise-technologies.vercel.app",
